  ...
  return (
    <div className="space-y-5 text-ink bg-muted pb-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="w-8 h-8 rounded-full bg-life-soft border border-life-line flex items-center justify-center">
      ...
      <div className="bg-card border border-line rounded-2xl p-5 space-y-4">
            ...
            <div className="flex items-center gap-4 mt-3">
              <div className="flex items-center gap-2">
                <div className="relative w-12 h-12">
                  <svg className="w-12 h-12 -rotate-90" viewBox="0 0 36 36">
                    ...
                    <circle cx="18" cy="18" r="16" fill="none" stroke="var(--color-life)" strokeWidth="3" 
              ...
              <div className="space-y-1 text-xs">
                <div className="flex items-center gap-1.5">
                  <Star className="w-3 h-3 text-life" />
                  <span className="text-subtle">{totalExperiencias} Experiências</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <Target className="w-3 h-3 text-life" />
        ...
        <div className="flex justify-end">
          <button className="text-[11px] font-semibold text-life flex items-center gap-1 hover:gap-2 transition-all">
      ...
      <div className="flex gap-2 overflow-x-auto pb-2 -mx-1 px-1 scrollbar-hide">
        {[
          ...
          <button key={i} className="shrink-0 bg-card border border-line rounded-xl px-3 py-2.5 flex items-center gap-2 hover:border-life transition-colors">
            <item.icon className="w-3.5 h-3.5 text-life" />
      ...
      <div className="bg-card border border-line rounded-xl p-4 space-y-3">
        ...
        <button className="w-full bg-card border border-line rounded-lg px-4 py-2.5 text-[11px] font-semibold text-ink hover:border-life transition-colors">
          ...
          {[
            ...
            <div key={i} className="space-y-1">
              ...
              <div className="w-full h-2 bg-muted rounded-full overflow-hidden">
                <div className="h-full bg-life rounded-full transition-all" style={{ width: `${item.value}%` }} />
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="bg-card border border-line rounded-xl p-4 space-y-3">
        ...
        <button className="text-[11px] font-semibold text-ink border border-line rounded-lg px-3 py-1.5 hover:border-life transition-colors">
          Ver mais
        </button>
      </div>
      ...
      <div className="bg-card border border-line rounded-xl p-4 space-y-3">
        ...
        <button className="flex items-center gap-1.5 bg-action hover:bg-action/90 text-white text-[11px] font-semibold rounded-lg px-3 py-2 transition-colors">
      ...
      <div className="bg-card border border-line rounded-xl p-4 space-y-3">
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            <div className="w-8 h-8 rounded-lg bg-life-soft border border-life-line flex items-center justify-center shrink-0">
          ...
          <div className="flex items-start gap-3">
            <div className="w-8 h-8 rounded-lg bg-action-soft border border-action-line flex items-center justify-center shrink-0">
