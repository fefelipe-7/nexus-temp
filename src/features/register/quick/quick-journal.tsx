  ...
  return (
    <div className="space-y-3">
      <div className="space-y-1">
        ...
        <textarea value={diarioText} onChange={e => setDiarioText(e.target.value)} placeholder="Hoje refleti sobre a autonomia pessoal e como pequenas escolhas constroem nossa biologia..." className="w-full h-24 text-xs border border-hairline rounded-lg p-2 bg-canvas focus:border-primary focus:outline-hidden resize-none placeholder-stone mt-1" />
      </div>
